      ...
      <div className="flex">
        <div className=" shadow ring-1 ring-gray-200 rounded-lg pt-4 text-center w-80 mb-4">
          <div className="flex items-center text-gray-900 px-3">
            ...
            <div className="flex-auto text-base font-bold">January</div>
            <button
              type="button"
              className="flex flex-none items-center justify-center text-gray-400 hover:text-gray-500"
            >
          ...
          <div className="mt-4 pb-1 grid grid-cols-7 text-xs leading-6 text-gray-500">
            <div>M</div>
            <div>T</div>
            <div>W</div>
            <div>T</div>
          ...
          <div className="isolate grid grid-cols-7 gap-px rounded-lg bg-gray-200 text-sm ring-1 ring-gray-200">
            {days.map((day, dayIdx) => (
              <button
                key={day.date}
                type="button"
