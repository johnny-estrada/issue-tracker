    ...
    <section>
      ...
      <form method="PUT" onSubmit={submitHandler} className="bg-white mb-5">
        ...
        <div className="flex items-center justify-end gap-x-6 py-4 px-8">
          ...
          <button
            type="submit"
            className="rounded-md border border-orange-500 px-6 lg:px-10 py-2 lg:py-3 text-sm lg:text-base text-orange-500 hover:text-white shadow-sm hover:bg-orange-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange-600"
          >
            Update password
          </button>
        </div>
