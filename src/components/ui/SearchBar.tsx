...
const SearchBar = (props) => {
  ...
  return (
    <form className="mt-14 rounded-md z-10">
      ...
      <div className="flex">
        <div className="relative z-10">
          ...
          <input
            ...
            name="desktop-search"
            id="desktop-search"
            className="hidden lg:w-72 rounded-full py-1.5 pl-10 bg-white text-sm leading-6 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-orange-500 outline-none lg:block shadow-sm h-12"
            placeholder="Search"
            value={search}
