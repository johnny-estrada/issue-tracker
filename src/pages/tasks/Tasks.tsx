...
const Tasks = () => {
  ...
  return (
    <>
      <Sidebar />
      <div className="grid grid-cols-1 lg:flex flex-col h-screen lg:ml-[288px]">
        <Header>
        ...
        <main className="grid grid-cols-1 lg:flex lg:h-screen ">
          {/* TOP PAGINATION */}
          <section
            aria-labelledby="tasks"
            className="flex-1 px-12 py-10 mb-auto"
          >
          ...
          <section
            aria-labelledby="tasks"
            className="flex-1 px-12 py-10 border-l border-gray-200"
          >
            <h2 className="sr-only" id="tasks">
              All Tasks
            </h2>
