...
const CreateProjectForm = () => {
  ...
  return (
    <>
      ...
      <main className="border border-green-500 my-auto mx-auto">
        <div>
          <section className="h-full my-auto border border-red-500">
            <form
              className="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl md:col-span-2 overflow-y-scroll scroll border my-auto h-[500px] border-blue-500"
